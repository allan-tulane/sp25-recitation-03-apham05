...
def _quadratic_multiply(x, y):
    ...
    a= _quadratic_multiply(xL, yL)
    b= _quadratic_multiply(xR, yR)
    c= _quadratic_multiply(BinaryNumber(xL.decimal_val + xR.decimal_val), BinaryNumber(yL.decimal_val + yR.decimal_val))
